...
| `CSRF_TRUSTED_ORIGINS`                  | vacío             | Orígenes de navegador adicionales con permiso para guardar cambios. Úsalo para un dominio público o un puerto inusual.                                                                |
...
| `AUTO_OPEN_BROWSER`              | `true`                                         | Si los lanzadores de shell abren la URL de la app por ti. Ponlo en `false` para detener esto.                                                                                                                                                                                                                                                                                                                                                                                  |
