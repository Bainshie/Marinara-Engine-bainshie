              ...
              return (
                ...
                >
                    ...
                    <span className="min-w-0 flex-1">
                      <span className="flex min-w-0 items-center gap-1.5">
                        ...
                        {skill.source === "bundled" && (
                          <span className="shrink-0 rounded-full bg-[var(--muted)]/50 px-1.5 py-0.5 text-[0.5625rem] font-semibold text-[var(--muted-foreground)]">{localizeUi("ui.chat.gamestoryboardpromptlibrary.builtIn")}</span>
                        )}
                      </span>
                  ...
                  <span className="flex shrink-0 items-center pr-1">
                    {skill.source === "bundled" ? (
                      <span
                        title={localizeUi("ui.chat.professormariskillsmenu.builtInSkillsAreAlwaysActive")}
                        className="px-1.5 text-[0.6rem] text-[var(--muted-foreground)]"
                      >{localizeUi("ui.chat.professormariskillsmenu.alwaysOn")}</span>
                    ) : (
                      <SettingsSwitch
